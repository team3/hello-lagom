...
/**
  * This is an event sourced entity. It has a state, [[HellolagomState]], which
...
class HellolagomEntity extends PersistentEntity {
  ...
  override type Command = HellolagomCommand[_]
...
/**
  ...
  */
sealed trait HellolagomCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends HellolagomCommand[Done]
...
object HellolagomSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    ...
    JsonSerializer[HellolagomState]
  )
}
